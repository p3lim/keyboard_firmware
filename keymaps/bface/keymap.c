...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [0] = LAYOUT(
        ...
        MO(1),   KC_LGUI, KC_LALT,                   KC_SPC,                             MO(2),   KC_RGUI, KC_RCTL
    ),
    ...
    */
    [1] = LAYOUT(
        ...
        _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, C_PSCR,  _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    */
    [2] = LAYOUT(
        _______, C_KVM1,  C_KVM2,  C_KVM3,  C_KVM4,  _______, _______, _______, _______, _______, _______, _______, _______, _______,
        ...
        KC_NO,   _______, _______,                   C_SPAM,                             _______, _______, _______
    ),
};
